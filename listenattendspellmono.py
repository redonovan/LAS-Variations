# Listen Attend & Spell speech recognition model with monotonicity loss.
# Written May-Sep 2021 (v21).
...
mloss_wt     = 0.5   # free choice, the monotonicity loss weight, a multiplier
...
num_epochs   = 9     # free choice, number of epochs of training
...
class Listener(keras.layers.Layer):
    def __init__(self, lis_dim, lis_layers, max_frames, mel_dim, **kwargs):
...
class TestModel(keras.Model):
    ...
    def __init__(self, lis_dim, lis_layers, max_frames, mel_dim, num_speakers, **kwargs):
        ...
        # setup components
        self.listener  = Listener(lis_dim, lis_layers, max_frames, mel_dim)
...
# tmodel = TestModel(lis_dim, lis_layers, max_frames, mel_dim, 20000)
# tmodel.compile(
